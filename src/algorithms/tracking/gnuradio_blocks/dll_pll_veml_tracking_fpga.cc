                ...
                case 1:  // Pull-in
                    {
                        ...
                        // D// LOG(INFO) << "PULL-IN Doppler [Hz] = " << d_carrier_doppler_hz
                        ...
                        // // D// LOG(INFO) << "Number of samples between Acquisition and Tracking = " << acq_trk_diff_samples << " ( " << acq_trk_diff_seconds << " s)";
