...
const char descriptor_table_protodef_monitor_5fpvt_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021monitor_pvt.proto\022\010gnss_sdr\"\242\004\n\nMonito"
  ...
  "lk_drift_ppm\030\035 \001(\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_monitor_5fpvt_2eproto = {
  false, false, descriptor_table_protodef_monitor_5fpvt_2eproto, "monitor_pvt.proto", 586,
...
void MonitorPvt::InternalSwap(MonitorPvt* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MonitorPvt, ar_ratio_threshold_)
      + sizeof(MonitorPvt::ar_ratio_threshold_)
